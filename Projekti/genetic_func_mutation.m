function genetic_func_mutation(arrayTaskNumber)
addpath('model');
%{
...
population_size = 30;
param_size = 14;
mutation_chance = 0.025*ceil(arrayTaskNumber/50);
...
while(iter_count <= iter_limit)
    ...
    % Break iteration if elite fitness hasen't improved on set number of
