...
\noindent This document is the project plan for the project Nature-Inspired Computing (NIC) Methods in Wind Generator Design for the course AS-32.000 Automaatio- ja systeemitekniikan projektity\"ot. Here we describe the goals, structure, time management and risks for the project.
